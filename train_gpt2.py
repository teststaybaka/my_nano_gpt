...
class GPT(nn.Module):
  ...
  def from_pretrained(cls, model_type):
    ...
    print(f"Loading pretrained model {model_type} from HuggingFace Transformers...")
    ...
    config_args['vocab_size'] = 50257 # always 50257 for GPT-2
    ...
    sd_keys_hf = [k for k in sd_keys_hf if not k.endswith('.attn.masked_bias')] # ignore .masked_bias
    sd_keys_hf = [k for k in sd_keys_hf if not k.endswith('.attn.bias')] # ignore .attn.bias
